// Group_b_05: dictionary consist of keyword and meaning use bst for implementation
...
int main()
{
    ...
    do
    {
        ...
        default:
            cout << "Invalid option do you want to continue YES- PRESS ONE OF OPTION  NO- PRESS 6 ....?\n";
            cin >> ch;
        }
    } while (ch <= 5);
    return 0;
