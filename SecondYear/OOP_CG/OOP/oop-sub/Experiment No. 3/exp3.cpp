...
Imagine a publishing company which does marketing for book and audio cassette versions.
 ...
 which adds a playing time in minutes (type float). Write a program that instantiates the book and tape classes,
 allows user to enter data and displays the data members. If an exception is caught, replace all the data member
